# structured-lesson-content Specification

## Purpose

Defines lesson content as genuinely structured data (grammar points,
vocabulary, dialogue, culture note) instead of a single flat-text field,
so the app can render real depth and so exercise generation can scale
with how much a lesson actually teaches.
